...
{
  auto act_node_type = FuncAnalyzer::analyze(expr);
...
{
  Expr expr = Expr::make_posi_literal(0);
  do_test(expr, BnNodeType::Buff);
}

TEST_F(FuncAnalyzerTest, nlit)
{
  Expr expr = Expr::make_nega_literal(0);
  do_test(expr, BnNodeType::Not);
}

TEST_F(FuncAnalyzerTest, and2)
{
  Expr lit0 = Expr::make_posi_literal(0);
  Expr lit1 = Expr::make_posi_literal(1);
  Expr expr = lit0 & lit1;
...
TEST_F(FuncAnalyzerTest, and3)
{
  Expr lit0 = Expr::make_posi_literal(0);
  Expr lit1 = Expr::make_posi_literal(1);
  Expr lit2 = Expr::make_posi_literal(2);
...
TEST_F(FuncAnalyzerTest, and4)
{
  ...
  Expr lit1 = Expr::make_posi_literal(1);
  Expr lit2 = Expr::make_posi_literal(2);
  Expr lit3 = Expr::make_posi_literal(3);
...
TEST_F(FuncAnalyzerTest, and5)
{
  ...
  Expr lit2 = Expr::make_posi_literal(2);
  Expr lit3 = Expr::make_posi_literal(3);
  Expr lit4 = Expr::make_posi_literal(4);
...
TEST_F(FuncAnalyzerTest, and6)
{
  ...
  Expr lit3 = Expr::make_posi_literal(3);
  Expr lit4 = Expr::make_posi_literal(4);
  Expr lit5 = Expr::make_posi_literal(5);
...
TEST_F(FuncAnalyzerTest, and7)
{
  ...
  Expr lit4 = Expr::make_posi_literal(4);
  Expr lit5 = Expr::make_posi_literal(5);
  Expr lit6 = Expr::make_posi_literal(6);
...
TEST_F(FuncAnalyzerTest, and8)
{
  ...
  Expr lit5 = Expr::make_posi_literal(5);
  Expr lit6 = Expr::make_posi_literal(6);
  Expr lit7 = Expr::make_posi_literal(7);
...
TEST_F(FuncAnalyzerTest, and9)
{
  ...
  Expr lit6 = Expr::make_posi_literal(6);
  Expr lit7 = Expr::make_posi_literal(7);
  Expr lit8 = Expr::make_posi_literal(8);
...
TEST_F(FuncAnalyzerTest, and10)
{
  ...
  Expr lit7 = Expr::make_posi_literal(7);
  Expr lit8 = Expr::make_posi_literal(8);
  Expr lit9 = Expr::make_posi_literal(9);
...
TEST_F(FuncAnalyzerTest, and11)
{
  ...
  Expr lit8 = Expr::make_posi_literal(8);
  Expr lit9 = Expr::make_posi_literal(9);
  Expr lit10 = Expr::make_posi_literal(10);
