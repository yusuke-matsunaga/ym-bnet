...
public:
  ...
  /// @brief Dffセルタイプの時 true を返す．
  bool
  is_dff_cell() const
  {
    return type() == BnDffType::DffCell;
  }

  /// @brief ラッチセルタイプの時 true を返す．
  virtual
  bool
  is_latch_cell() const
  {
    return type() == BnDffType::LatchCell;
  }
...
public:
  //////////////////////////////////////////////////////////////////////
  /// @name DFFセルタイプ/ラッチセルタイプに共通な外部インターフェイス
  //////////////////////////////////////////////////////////////////////
