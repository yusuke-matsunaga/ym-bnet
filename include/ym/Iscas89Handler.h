...
protected:
  ...
  /// @brief コンストラクタ
  Iscas89Handler(Iscas89Parser& parser); ///< [in] ISCAS89 パーサー
...
public:
  ...
  virtual
  bool
  read_input(const FileRegion& loc, ///< [in] ファイル位置
  ...
  virtual
  bool
  read_output(const FileRegion& loc, ///< [in] ファイル位置
  ...
  virtual
  bool
  read_gate(const FileRegion& loc,          ///< [in] ファイル位置
  ...
  virtual
  bool
  read_mux(const FileRegion& loc,          ///< [in] ファイル位置
	   int oname_id,                   ///< [in] 出力名の ID 番号
	   const string& oname,            ///< [in] 出力名
	   const vector<int>& iname_list); ///< [in] 入力名のリスト
  ...
  virtual
  bool
  read_dff(const FileRegion& loc, ///< [in] ファイル位置
	   int oname_id,          ///< [in] 出力名の ID 番号
	   const string& oname,   ///< [in] 出力名
...
protected:
  ...
  /// @brief ID 番号から文字列を得る．
  const string&
  id2str(int id) const; ///< [in] ID番号

  /// @brief ID 番号から位置情報を得る．
  FileRegion
  id2loc(int id) const; ///< [in] ID番号
